...
data modify entity @s Item.tag.display.Lore append value '{"text":"Unusual Effect: Love in the Air","color":"dark_purple","bold":false,"italic":true,"underlined":false,"strikethrough":false,"obfuscated":false}'
