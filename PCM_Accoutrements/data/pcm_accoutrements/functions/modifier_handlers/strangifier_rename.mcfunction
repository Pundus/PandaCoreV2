...
data modify block 0 0 0 Text1 set value '["",{"translate":"pcm2.items.name.prefix.modified","color":"aqua","italic":"false"},{"text":" ✻ ","color":"aqua","italic":"false"},{"nbt":"Item.tag.display.Name","entity":"@e[type=item,tag=pcm2_strangifier_rename,limit=1]","interpret":"true","color":"aqua"}]'
