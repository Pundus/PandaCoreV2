...
execute as @s unless score PCM2_HatOverride pcm2_override matches 1.. run scoreboard players set pcm2_mfhu PC_RNG 4
execute as @s unless score PCM2_HatOverride pcm2_override matches 1.. run scoreboard players operation @s PC_RNG %= pcm2_mfhu PC_RNG
execute at @s unless score PCM2_HatOverride pcm2_override matches 1.. run tell @a[tag=pcm2_DEBUG] BEGIN MODIFIER TYPE SELECT
...
execute at @s[tag=pcm2_modifier_suni] run data modify entity @s[tag=pcm2_modifier_suni] Item.tag.display.Lore prepend value '{"text":"Hat: Universal","color":"dark_aqua","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}'
...
#HATS
execute at @s if score @s PC_RNG matches 1.. run tag @s add pcm2_modifier_shat
...
execute as @s[tag=pcm2_modifier_shat] unless score PCM2_HatOverride pcm2_override matches 1.. run scoreboard players set pcm2_mfh PC_RNG 19
...
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 0 run data modify entity @s[tag=pcm2_modifier_shat] Item.tag.display.Lore prepend value '{"text":"Hat: Hot Dogger","color":"dark_aqua","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}'
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 0 run tell @a[tag=pcm2_DEBUG] MODIFIER: HOT DOGGER
...
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 1 run data modify entity @s[tag=pcm2_modifier_shat] Item.tag.display.Lore prepend value '{"text":"Hat: Bear Necessities","color":"dark_aqua","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}'
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 1 run tell @a[tag=pcm2_DEBUG] MODIFIER: BEAR NECESSITIES
...
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 2 run data modify entity @s[tag=pcm2_modifier_shat] Item.tag.display.Lore prepend value '{"text":"Hat: Headstack","color":"dark_aqua","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}'
...
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 3 run data modify entity @s[tag=pcm2_modifier_shat] Item.tag.display.Lore prepend value '{"text":"Hat: Zombie Pal","color":"dark_aqua","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}'
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 3 run tell @a[tag=pcm2_DEBUG] MODIFIER: ZOMBIE PAL
...
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 4 run data modify entity @s[tag=pcm2_modifier_shat] Item.tag.display.Lore prepend value '{"text":"Hat: Popeyes","color":"dark_aqua","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}'
...
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 5 run data modify entity @s[tag=pcm2_modifier_shat] Item.tag.display.Lore prepend value '{"text":"Hat: Cone Head","color":"dark_aqua","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}'
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 5 run tell @a[tag=pcm2_DEBUG] MODIFIER: CONE HEAD
...
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 6 run data modify entity @s[tag=pcm2_modifier_shat] Item.tag.display.Lore prepend value '{"text":"Hat: Party Hat","color":"dark_aqua","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}'
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 6 run tell @a[tag=pcm2_DEBUG] MODIFIER: PARTY HAT
...
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 7 run data modify entity @s[tag=pcm2_modifier_shat] Item.tag.display.Lore prepend value '{"text":"Hat: Sergeant\'s Peak","color":"dark_aqua","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}'
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 7 run tell @a[tag=pcm2_DEBUG] MODIFIER: SERGEANTS PEAK
...
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 8 run data modify entity @s[tag=pcm2_modifier_shat] Item.tag.display.Lore prepend value '{"text":"Hat: Soviet Enforcement","color":"dark_aqua","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}'
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 8 run tell @a[tag=pcm2_DEBUG] MODIFIER: SOVIET ENFORCEMENT
...
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 9 run data modify entity @s[tag=pcm2_modifier_shat] Item.tag.display.Lore prepend value '{"text":"Hat: Racer\'s Goggles","color":"dark_aqua","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}'
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 9 run tell @a[tag=pcm2_DEBUG] MODIFIER: RACERS GOGGLES
...
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 10 run data modify entity @s[tag=pcm2_modifier_shat] Item.tag.display.Lore prepend value '{"text":"Hat: Fallen Angel","color":"dark_aqua","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}'
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 10 run tell @a[tag=pcm2_DEBUG] MODIFIER: FALLEN ANGEL
...
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 11 run data modify entity @s[tag=pcm2_modifier_shat] Item.tag.display.Lore prepend value '{"text":"Hat: Dual Hair Ribbons","color":"dark_aqua","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}'
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 11 run tell @a[tag=pcm2_DEBUG] MODIFIER: DUAL HAIR RIBBONS
...
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 12 run data modify entity @s[tag=pcm2_modifier_shat] Item.tag.display.Lore prepend value '{"text":"Hat: Take the Plunge","color":"dark_aqua","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}'
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 12 run tell @a[tag=pcm2_DEBUG] MODIFIER: TAKE THE PLUNGE
...
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 13 run data modify entity @s[tag=pcm2_modifier_shat] Item.tag.display.Lore prepend value '{"text":"Hat: Doctor\'s Mirror","color":"dark_aqua","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}'
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 13 run tell @a[tag=pcm2_DEBUG] MODIFIER: DOCTOR\'s MIRROR
...
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 14 run data modify entity @s[tag=pcm2_modifier_shat] Item.tag.display.Lore prepend value '{"text":"Hat: 3D Glasses","color":"dark_aqua","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}'
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 14 run tell @a[tag=pcm2_DEBUG] MODIFIER: 3D GLASSES
...
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 15 run data modify entity @s[tag=pcm2_modifier_shat] Item.tag.display.Lore prepend value '{"text":"Hat: Sweet Tooth","color":"dark_aqua","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}'
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 15 run tell @a[tag=pcm2_DEBUG] MODIFIER: SWEET TOOTH
...
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 16 run data modify entity @s[tag=pcm2_modifier_shat] Item.tag.display.Lore prepend value '{"text":"Hat: No U","color":"dark_aqua","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}'
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 16 run tell @a[tag=pcm2_DEBUG] MODIFIER: NO U

execute at @s if score PCM2_HatOverride pcm2_override matches 16 run data modify entity @s[tag=pcm2_modifier_shat] Item.tag merge value {pcm2_nou:1}
execute at @s if score PCM2_HatOverride pcm2_override matches 16 run data modify entity @s[tag=pcm2_modifier_shat] Item.tag merge value {pcm2_sfhat_applied:1}
execute at @s if score PCM2_HatOverride pcm2_override matches 16 run data modify entity @s[tag=pcm2_modifier_shat] Item.tag.display.Lore prepend value '{"text":"Hat: No U","color":"dark_aqua","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}'
...
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 17 run data modify entity @s[tag=pcm2_modifier_shat] Item.tag.display.Lore prepend value '{"text":"Hat: Officer\'s Cap","color":"dark_aqua","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}'
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 17 run tell @a[tag=pcm2_DEBUG] MODIFIER: OFFICER\'s CAP
...
#UNIVERSAL
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 18 run data modify entity @s[tag=pcm2_modifier_shat] Item.tag merge value {pcm2_universalmod:1}
...
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 18 run data modify entity @s[tag=pcm2_modifier_shat] Item.tag.display.Lore prepend value '{"text":"Hat: Universal","color":"dark_aqua","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}'
execute at @s[tag=pcm2_modifier_shat] if score @s[tag=pcm2_modifier_shat] PC_RNG matches 18 run tell @a[tag=pcm2_DEBUG] MODIFIER: UNIVERSAL

execute at @s if score PCM2_HatOverride pcm2_override matches 18 run data modify entity @s Item.tag merge value {pcm2_universalmod:1}
execute at @s if score PCM2_HatOverride pcm2_override matches 18 run data modify entity @s Item.tag merge value {pcm2_sfhat_applied:1}
execute at @s if score PCM2_HatOverride pcm2_override matches 18 run data modify entity @s Item.tag.display.Lore prepend value '{"text":"Hat: Universal","color":"dark_aqua","bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}'
