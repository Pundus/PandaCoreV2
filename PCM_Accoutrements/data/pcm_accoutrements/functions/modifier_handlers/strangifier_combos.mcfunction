...
execute as @s[tag=pcm2_svalid] at @s as @e[type=item,nbt={Item:{tag:{pcm2_hat:1}}},nbt=!{Item:{tag:{pcm2_nostrange:1}}},nbt=!{Item:{tag:{pcm_modified:1}}},distance=..0.5,limit=1,tag=pcm2_hsvalid] run tell @a[tag=pcm2_DEBUG] STRANGIFIER RENAME
...
execute as @s[tag=pcm2_svalid,nbt={Item:{tag:{pcm2_strangifier:1}}}] if entity @e[type=item,nbt={Item:{tag:{pcm2_modified:1,pcm2_hat:1,pcm2_strange:1}}},distance=..0.5,limit=1] run playsound minecraft:item.trident.thunder player @p ~ ~ ~ 1 1 1
execute as @s[tag=pcm2_svalid,nbt={Item:{tag:{pcm2_strangifier:1}}}] if entity @e[type=item,nbt={Item:{tag:{pcm2_modified:1,pcm2_hat:1,pcm2_strange:1}}},distance=..0.5,limit=1] run particle lava ~ ~ ~ 0.05 0.05 0.05 .25 25 force @a[distance=..10]
execute as @s[tag=pcm2_svalid,nbt={Item:{tag:{pcm2_strangifier:1}}}] if entity @e[type=item,nbt={Item:{tag:{pcm2_modified:1,pcm2_hat:1,pcm2_strange:1}}},distance=..0.5,limit=1] run kill @s
