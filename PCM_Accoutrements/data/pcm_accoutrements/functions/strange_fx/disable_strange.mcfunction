...
execute as @a[nbt={Inventory:[{Slot:-106b,tag:{pcm2_strange:1}}]},nbt=!{Inventory:[{Slot:-106b,tag:{pcm2_nostrange:1}}]}] run title @s actionbar {"translate":"pcm2.ui.strangefx_disable"}
...
execute as @a[nbt={Inventory:[{Slot:-106b,tag:{pcm2_nostrange:1}}]}] run title @s actionbar {"translate":"pcm2.ui.strangefx_enable"}
