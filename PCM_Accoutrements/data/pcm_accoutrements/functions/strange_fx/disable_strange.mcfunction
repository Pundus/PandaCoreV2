...
execute as @a[nbt={Inventory:[{Slot:-106b,tag:{pcm2_strange:1}}]},nbt=!{Inventory:[{Slot:-106b,tag:{pcm2_nostrange:1}}]}] run data modify block -1 0 -1 Items[0].tag.display.Lore prepend value '{"text":"Effect Disabled","color":"dark_gray","bold":false,"italic":true,"underlined":false,"strikethrough":false,"obfuscated":false}'
