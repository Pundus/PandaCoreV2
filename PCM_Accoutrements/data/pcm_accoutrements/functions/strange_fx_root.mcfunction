...
execute as @a[nbt={Inventory:[{Slot:103b,tag:{pcm2_fireballdefender:1}}]},nbt=!{Inventory:[{Slot:103b,tag:{pcm2_nostrange:1}}]}] run function pcm_accoutrements:strange_fx/fireball_defender
execute as @a[nbt={Inventory:[{Slot:103b,tag:{pcm2_highjump:1}}]},nbt=!{Inventory:[{Slot:103b,tag:{pcm2_nostrange:1}}]}] run function pcm_accoutrements:strange_fx/high_jump
execute as @a[nbt={Inventory:[{Slot:103b,tag:{pcm2_nightsight:1}}]},nbt=!{Inventory:[{Slot:103b,tag:{pcm2_nostrange:1}}]}] run function pcm_accoutrements:strange_fx/night_sight
execute as @a[nbt={Inventory:[{Slot:103b,tag:{pcm2_safelanding:1}}]},nbt=!{Inventory:[{Slot:103b,tag:{pcm2_nostrange:1}}]}] run function pcm_accoutrements:strange_fx/safe_landing
execute as @a[nbt={Inventory:[{Slot:103b,tag:{pcm2_poisonimmunity:1}}]},nbt=!{Inventory:[{Slot:103b,tag:{pcm2_nostrange:1}}]}] run function pcm_accoutrements:strange_fx/poison_immunity
execute as @a[nbt={Inventory:[{Slot:103b,tag:{pcm2_vindicated:1}}]},nbt=!{Inventory:[{Slot:103b,tag:{pcm2_nostrange:1}}]}] run function pcm_accoutrements:strange_fx/vindicated
execute as @a[nbt={Inventory:[{Slot:103b,tag:{pcm2_opm:1}}]},nbt=!{Inventory:[{Slot:103b,tag:{pcm2_nostrange:1}}]}] run function pcm_accoutrements:strange_fx/one_punch_man
execute as @a[nbt={Inventory:[{Slot:103b,tag:{pcm2_evasive:1}}]},nbt=!{Inventory:[{Slot:103b,tag:{pcm2_nostrange:1}}]}] run function pcm_accoutrements:strange_fx/evasive_manoeuvres
