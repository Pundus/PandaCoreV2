...
#rainy day
execute as @a[gamemode=!spectator,nbt={Inventory:[{Slot:103b,tag:{pcm2_unus_rd:1}}]}] anchored eyes at @s run particle cloud ~ ~3 ~ 0.15 0 0.15 0.01 3 force @a[tag=!pcm2_disableunus]
...
execute as @a[gamemode=!spectator,nbt={SelectedItem:{tag:{pcm2_unus_rd:1}}}] at @s anchored feet positioned ~ ~2.5 ~ run particle cloud ^-0.5 ^ ^ 0.1 0 0.1 0 1 force @a[tag=!pcm2_disableunus]
...
execute as @a[gamemode=!spectator,nbt={Inventory:[{Slot:-106b,tag:{pcm2_unus_rd:1}}]}] at @s anchored feet positioned ~ ~2.5 ~ run particle cloud ^0.5 ^ ^ 0.1 0 0.1 0 1 force @a[tag=!pcm2_disableunus]
...
execute as @e[type=item,nbt={Item:{tag:{pcm2_unus_rd:1}}}] anchored eyes at @s run particle cloud ~ ~2 ~ 0.15 0 0.15 0.01 3 force @a[tag=!pcm2_disableunus,distance=..10]
