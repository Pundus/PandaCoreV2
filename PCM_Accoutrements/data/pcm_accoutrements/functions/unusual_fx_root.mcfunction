...
execute if score %PCMA_UFX_T PC_RNG matches 5.. run scoreboard players reset %PCMA_UFX_T PC_RNG
...
execute if score %PCMA_UFX_T PC_RNG matches 4 as @e[type=#pcm_accoutrements:item_handlers,nbt={Item:{tag:{pcm2_unusualifier:1}}}] at @s run function pcm_accoutrements:unusual_fx/items