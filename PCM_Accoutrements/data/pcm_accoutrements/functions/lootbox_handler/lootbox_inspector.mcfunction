...
#tiers
execute if score PCM2_Strange pcm2_SETTINGS matches 1 as @s run data modify block -1 0 -1 Items[0].tag.display.Lore append value '{"translate":"pcm2.items.lootbox.tier1","italic":false,"color":"dark_purple"}'
execute if score PCM2_Unusual pcm2_SETTINGS matches 1 as @s run data modify block -1 0 -1 Items[0].tag.display.Lore append value '{"translate":"pcm2.items.lootbox.tier2","italic":false,"color":"dark_purple"}'


execute if score PCM2_BonusDrops pcm2_SETTINGS matches 1 as @s run data modify block -1 0 -1 Items[0].tag.display.Lore append value '{"translate":"pcm2.items.lootbox.bonus","italic":false,"color":"gray"}'
...
execute as @s run title @s actionbar {"translate":"pcm2.ui.description_open"}
