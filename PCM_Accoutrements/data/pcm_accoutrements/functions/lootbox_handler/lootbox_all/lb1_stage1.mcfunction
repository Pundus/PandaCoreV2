...
execute if score @s PC_RNG matches 4 run loot spawn ~ ~ ~ loot pcm_accoutrements:hats/hotdogger
execute if score @s PC_RNG matches 5 run loot spawn ~ ~ ~ loot pcm_accoutrements:hats/zombiepal
execute if score @s PC_RNG matches 6 run loot spawn ~ ~ ~ loot pcm_accoutrements:hats/popeyes