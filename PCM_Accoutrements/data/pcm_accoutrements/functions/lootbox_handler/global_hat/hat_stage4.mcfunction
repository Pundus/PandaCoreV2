...
execute if score PCM2_UnusualStrange pcm2_SETTINGS matches 1 if entity @e[type=item,nbt={Item:{tag:{pcm2_hat:1}},OnGround:1b},distance=..0.5,tag=pcm2_unusualspawn] run tellraw @a ["",{"selector":"@p[tag=pcm2_heldstuff]","color":"light_purple"},{"translate":"pcm2.unboxing.unusual1","color":"light_purple"},{"nbt":"Item.tag.display.Name","interpret":"true","entity":"@e[type=item,nbt={Item:{tag:{pcm2_hat:1}},OnGround:1b},distance=..0.5,tag=pcm2_unusualspawn]","color":"light_purple"},{"translate":"pcm2.unboxing.withfx","color":"light_purple"},{"nbt":"Item.tag.display.Lore[0]","interpret":"true","entity":"@e[type=item,nbt={Item:{tag:{pcm2_hat:1}},OnGround:1b},distance=..0.5,tag=pcm2_unusualspawn]","color":"light_purple","italic":true},{"translate":"pcm2.unboxing.and","color":"light_purple"},{"nbt":"Item.tag.display.Lore[1]","interpret":"true","entity":"@e[type=item,nbt={Item:{tag:{pcm2_hat:1}},OnGround:1b},distance=..0.5,tag=pcm2_unusualspawn]","color":"light_purple","italic":true},{"text":"!","color":"light_purple"}]
execute if score PCM2_UnusualStrange pcm2_SETTINGS matches 1 if entity @e[type=item,nbt={Item:{tag:{pcm2_hat:1}},OnGround:1b},distance=..0.5,tag=pcm2_unusualspawn] run playsound minecraft:ui.toast.challenge_complete player @a[distance=..10] ~ ~ ~ 1 1.5 1

execute if score PCM2_UnusualStrange pcm2_SETTINGS matches 0 if entity @e[type=item,nbt={Item:{tag:{pcm2_hat:1}},OnGround:1b},distance=..0.5,tag=pcm2_unusualspawn] run tellraw @a ["",{"selector":"@p[tag=pcm2_heldstuff]","color":"light_purple"},{"translate":"pcm2.unboxing.unusual1","color":"light_purple"},{"nbt":"Item.tag.display.Name","interpret":"true","entity":"@e[type=item,nbt={Item:{tag:{pcm2_hat:1}},OnGround:1b},distance=..0.5,tag=pcm2_unusualspawn]","color":"light_purple"},{"translate":"pcm2.unboxing.withfx","color":"light_purple"},{"nbt":"Item.tag.display.Lore[0]","interpret":"true","entity":"@e[type=item,nbt={Item:{tag:{pcm2_hat:1}},OnGround:1b},distance=..0.5,tag=pcm2_unusualspawn]","color":"light_purple","italic":true},{"text":"!","color":"light_purple"}]
execute if score PCM2_UnusualStrange pcm2_SETTINGS matches 0 if entity @e[type=item,nbt={Item:{tag:{pcm2_hat:1}},OnGround:1b},distance=..0.5,tag=pcm2_unusualspawn] run playsound minecraft:ui.toast.challenge_complete player @a[distance=..10] ~ ~ ~ 1 1.5 1
