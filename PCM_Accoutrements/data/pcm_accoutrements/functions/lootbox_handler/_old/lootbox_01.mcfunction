...
execute as @e[type=armor_stand,tag=pcm2_unbox_marker1,scores={pcm2_lbsequence=2,pcm2_lbnumber=1}] at @s run function pcm_accoutrements:lootbox_handler/lootbox_01/stage1
execute as @e[type=armor_stand,tag=pcm2_unbox_marker1,scores={pcm2_lbsequence=2,pcm2_lbnumber=2}] at @s run function pcm_accoutrements:lootbox_handler/lootbox_02/stage1
