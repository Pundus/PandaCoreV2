...
execute as @e[type=armor_stand,tag=pcm2_unbox_marker1,scores={pcm2_lbsequence=2,pcm2_lbnumber=4}] at @s run function pcm_accoutrements:lootbox_handler/lootbox_all/lb4_stage1
execute as @e[type=armor_stand,tag=pcm2_unbox_marker1,scores={pcm2_lbsequence=2,pcm2_lbnumber=5}] at @s run function pcm_accoutrements:lootbox_handler/lootbox_all/lb5_stage1
