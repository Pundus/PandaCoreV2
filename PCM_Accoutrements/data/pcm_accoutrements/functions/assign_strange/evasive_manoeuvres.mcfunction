...
data modify entity @s Item.tag.display.Lore prepend value '{"text":"Strange Effect: Evasive Manoeuvres","color":"gold","bold":false,"italic":true,"underlined":false,"strikethrough":false,"obfuscated":false}'
