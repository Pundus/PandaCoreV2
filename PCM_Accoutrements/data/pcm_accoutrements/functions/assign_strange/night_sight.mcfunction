...
data modify entity @s Item.tag.display.Lore append value '{"text":"Strange Effect: Night Sight","color":"gold","bold":false,"italic":true,"underlined":false,"strikethrough":false,"obfuscated":false}'
