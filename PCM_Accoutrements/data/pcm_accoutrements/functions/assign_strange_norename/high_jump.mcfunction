...
data modify entity @s Item.tag.display.Lore append value '{"text":"Strange Effect: High Jump","color":"gold","bold":false,"italic":true,"underlined":false,"strikethrough":false,"obfuscated":false}'
