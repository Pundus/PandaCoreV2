...
execute if score %ZomType ARS_Gamemodes matches 0 run function pcm_arsenal:gamemodes/cd/zombie_types/tough_zombie
...
execute if score %ZomType ARS_Gamemodes matches 6..9 run function pcm_arsenal:gamemodes/cd/zombie_types/basic_zombie
