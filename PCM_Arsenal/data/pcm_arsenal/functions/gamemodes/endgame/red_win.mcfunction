...
execute as @a[team=red] run function pcm_arsenal:gamemodes/endgame/pvp_reward_win
execute as @a[team=blue] run function pcm_arsenal:gamemodes/endgame/lose_quote
execute as @a[team=blue] run function pcm_arsenal:gamemodes/endgame/pvp_reward_lose
