...
# tips
tellraw @s [{"translate":"arsenal.menu.prefixor"},{"translate":"arsenal.menu.icon.arrow"},{"translate":"arsenal.menu.icon.folder"},{"translate":"arsenal.menu.options.tips","hoverEvent":{"action":"show_text","value":[{"translate":"arsenal.menu.options.tips.info"},{"text":"\n"},{"translate":"arsenal.menu.default","color":"gray"},{"translate":"arsenal.menu.default.enabled","color":"gray"}]}}]

tellraw @s[tag=!ARS_DisableChatTips] [{"translate":"arsenal.menu.prefixor"},{"translate":"arsenal.menu.options.newline"},{"translate":"arsenal.menu.enabled","color":"green"},{"translate":"arsenal.menu.toggle","color":"gray","clickEvent":{"action":"run_command","value":"/trigger ARS_MenuSys set 16"},"hoverEvent":{"action":"show_text","value":[{"translate":"arsenal.menu.toggle.info"}]}}]

tellraw @s[tag=ARS_DisableChatTips] [{"translate":"arsenal.menu.prefixor"},{"translate":"arsenal.menu.options.newline"},{"translate":"arsenal.menu.disabled","color":"red"},{"translate":"arsenal.menu.toggle","color":"gray","clickEvent":{"action":"run_command","value":"/trigger ARS_MenuSys set 16"},"hoverEvent":{"action":"show_text","value":[{"translate":"arsenal.menu.toggle.info"}]}}]


#Pages
tellraw @s [{"translate":"arsenal.menu.prefixor"},{"translate":"arsenal.menu.page.prev","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger ARS_MenuSys set 101"},"hoverEvent":{"action":"show_text","value":[{"translate":"arsenal.menu.page.prev.info"}]}},{"translate":"arsenal.menu.page.bracket.open","color":"white"},{"text":"2","color":"white"},{"translate":"arsenal.menu.page.bracket.close","color":"white"},{"translate":"arsenal.menu.page.next","color":"dark_gray"}]
