...
execute as @s[nbt={Item:{tag:{arsenal_grenade:"incen"}}}] at @s run function pcm_arsenal:grenades/detonate/incendiary_root
execute as @s[nbt={Item:{tag:{arsenal_grenade:"molotov"}}}] at @s run function pcm_arsenal:grenades/detonate/molotov_root