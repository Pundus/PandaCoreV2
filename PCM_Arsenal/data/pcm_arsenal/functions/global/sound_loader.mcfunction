...
execute as @s[predicate=!pcm_arsenal:held_item/suppressed,nbt={SelectedItem:{tag:{arsenal_loudness:4b}}}] at @s positioned ~ ~-62 ~ run function pcm_arsenal:global/sound/big_loop
execute as @s[predicate=!pcm_arsenal:held_item/suppressed,nbt={SelectedItem:{tag:{arsenal_loudness:5b}}}] at @s positioned ~ ~-62 ~ run function pcm_arsenal:global/sound/large_loop
execute as @s[predicate=!pcm_arsenal:held_item/suppressed,nbt={SelectedItem:{tag:{arsenal_loudness:6b}}}] at @s positioned ~ ~-62 ~ run function pcm_arsenal:global/sound/loud_loop
