...
execute as @s[scores={ARS_TotalMags=0},nbt=!{SelectedItem:{tag:{arsenal_halfmag:1b,arsenal_mag:"p90"}}},predicate=!pcm_arsenal:offhand_item/ammo_0_off] at @s run function pcm_arsenal:reload/pdw/p90/p90_reload_alt
