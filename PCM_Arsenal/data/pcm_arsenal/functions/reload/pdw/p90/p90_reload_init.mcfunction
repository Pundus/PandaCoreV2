...
execute as @s[scores={ARS_TotalMags=0},nbt=!{SelectedItem:{tag:{arsenal_halfmag:1b,arsenal_mag:"p90"}}}] at @s run function pcm_arsenal:reload/pdw/p90/p90_reload_alt
