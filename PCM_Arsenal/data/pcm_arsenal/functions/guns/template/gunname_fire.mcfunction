#This function deals with shooting a gunname
...
execute as @s[predicate=!pcm_arsenal:held_item/suppressed] at @s run playsound minecraft:gunname.shoot player @a ~ ~ ~ 1 1 0
