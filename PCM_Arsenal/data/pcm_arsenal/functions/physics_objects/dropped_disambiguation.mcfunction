...
execute as @s[nbt={Item:{tag:{arsenal_phys_drop:"case_medium"}}}] at @s run playsound drop.case.medium player @a ~ ~ ~ 1 1 0
...
execute as @s[nbt={Item:{tag:{arsenal_phys_drop:"mag_stripper_clip"}}}] at @s run playsound drop.mag.stripper_clip player @a ~ ~ ~ 1 1 0
...
execute as @s[nbt={Item:{tag:{arsenal_phys_drop:"gun_wood"}}}] at @s run playsound drop.gun.wood player @a ~ ~ ~ 1 1 0
...
execute as @s[nbt={Item:{tag:{arsenal_phys_drop:"gun_wood"}}}] at @s run playsound drop.gun.generic player @a ~ ~ ~ 1 1 0
...
execute as @s[nbt={Item:{tag:{arsenal_phys_drop:"grenade_molotov"}}}] at @s run playsound drop.grenade.molotov player @a ~ ~ ~ 1 1 0
