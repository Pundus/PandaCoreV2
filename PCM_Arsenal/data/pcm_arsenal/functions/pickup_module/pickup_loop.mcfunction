...
execute as @e[type=item,nbt={Item:{tag:{arsenal_iscrt:1b}}}] at @s unless entity @e[type=item,nbt={Item:{tag:{arsenal_iscrt:1b}}},distance=0.01..1.5] run function pcm_arsenal:pickup_module/lock_items

execute as @e[type=item,nbt={Item:{tag:{arsenal_iscrt:1b}}},tag=ARS_PickupLocked] at @s if entity @e[type=item,nbt={Item:{tag:{arsenal_iscrt:1b}}},distance=0.01..1.5] run function pcm_arsenal:pickup_module/unlock_items
