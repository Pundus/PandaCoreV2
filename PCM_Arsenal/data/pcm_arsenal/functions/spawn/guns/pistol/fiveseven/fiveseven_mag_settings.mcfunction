#Load in info from scoreboard to set for fiveseven magazines
...
execute store result entity @s Item.tag.arsenal_magrounds int 1 run scoreboard players get %FiveSeven ARS_SET_Rounds
...
tag @a[tag=semireload_fiveseven] remove semireload_fiveseven

#rounds 
execute as @s[nbt={Item:{tag:{arsenal_halfmag:0b}}}] run data modify block ~ 0 ~ Text1 set value '[{"translate": "arsenal.item.stats.rounds","color": "gray","italic": false},{"score":{"name":"%FiveSeven","objective":"ARS_SET_Rounds"}},{"translate": "arsenal.item.stats.outof","color": "gray","italic": false},{"score":{"name":"%FiveSeven","objective":"ARS_SET_Rounds"}},{"translate": "arsenal.stats.rounds.rounds","color": "gray","italic": false}]'

# for a newly spawned halfmag
execute as @s[nbt={Item:{tag:{arsenal_halfmag:1b}}}] run data modify block ~ 0 ~ Text1 set value '[{"translate": "arsenal.item.stats.rounds","color": "gray","italic": false},{"score":{"name":"@e[nbt={Item:{tag:{arsenal_halfmag:1b,arsenal_justspawned:1b}}}]","objective":"ARS_TEMP_Rnds"}},{"translate": "arsenal.item.stats.outof","color": "gray","italic": false},{"score":{"name":"%FiveSeven","objective":"ARS_SET_Rounds"}},{"translate": "arsenal.stats.rounds.rounds","color": "gray","italic": false}]'
