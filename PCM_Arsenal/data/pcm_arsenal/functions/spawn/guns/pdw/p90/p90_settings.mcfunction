...
execute store result entity @s Item.tag.arsenal_shotshell byte 1 run scoreboard players get %P90 ARS_SET_ShotShl
execute store result entity @s Item.tag.arsenal_threeburst byte 1 run scoreboard players get %P90 ARS_SET_TRB
execute store result entity @s Item.tag.arsenal_implicitads byte 1 run scoreboard players get %P90 ARS_SET_ImpADS
execute store result entity @s Item.tag.arsenal_allowspb byte 1 run scoreboard players get %P90 ARS_SET_AllowSPB
...
########## DEPRECATED ##############################################################################################################################################################
####################rounds
####################data modify block ~ 0 ~ Text1 set value '[{"translate": "arsenal.item.stats.rounds","color": "gray","italic": false},{"score":{"name":"%P90","objective":"ARS_SET_Rounds"},"color": "white"},{"translate": "arsenal.stats.rounds.rounds","color": "gray","italic": false}]'
...
#recoil
data modify block ~ 0 ~ Text1 set value '[{"translate": "arsenal.item.stats.recoil","color": "gray","italic": false},{"score":{"name":"%P90","objective":"ARS_SET_Recoil"},"color": "red"}]'

data modify entity @s Item.tag.display.Lore[6] set from block ~ 0 ~ Text1

#range
data modify block ~ 0 ~ Text1 set value '[{"translate": "arsenal.item.stats.range","color": "gray","italic": false},{"score":{"name":"%P90","objective":"ARS_SET_Range"},"color": "dark_aqua"}]'

data modify entity @s Item.tag.display.Lore[7] set from block ~ 0 ~ Text1

#damage
data modify block ~ 0 ~ Text1 set value '[{"translate": "arsenal.item.stats.damage","color": "gray","italic": false},{"score":{"name":"%P90","objective":"ARS_SET_Damage"},"color": "dark_aqua"}]'

data modify entity @s Item.tag.display.Lore[8] set from block ~ 0 ~ Text1

#piercing
data modify block ~ 0 ~ Text1 set value '[{"translate": "arsenal.item.stats.piercing","color": "gray","italic": false},{"score":{"name":"%P90","objective":"ARS_SET_Piercing"},"color": "dark_aqua"}]'

data modify entity @s Item.tag.display.Lore[9] set from block ~ 0 ~ Text1

#loudness
data modify block ~ 0 ~ Text1 set value '[{"translate": "arsenal.item.stats.loudness","color": "gray","italic": false},{"score":{"name":"%P90","objective":"ARS_SET_Loudness"},"color": "red"}]'

data modify entity @s Item.tag.display.Lore[10] set from block ~ 0 ~ Text1

#rof
data modify block ~ 0 ~ Text1 set value '[{"translate": "arsenal.item.stats.rof","color": "gray","italic": false},{"score":{"name":"%P90","objective":"ARS_SET_RoFDis"},"color": "dark_aqua"}]'

data modify entity @s Item.tag.display.Lore[11] set from block ~ 0 ~ Text1

#relaodt
data modify block ~ 0 ~ Text1 set value '[{"translate": "arsenal.item.stats.reloadt","color": "gray","italic": false},{"score":{"name":"%P90","objective":"ARS_SET_ReloadT"},"color": "red"}]'

data modify entity @s Item.tag.display.Lore[12] set from block ~ 0 ~ Text1

#force
data modify block ~ 0 ~ Text1 set value '[{"translate": "arsenal.item.stats.force","color": "gray","italic": false},{"score":{"name":"%P90","objective":"ARS_SET_Force"},"color": "dark_aqua"}]'

data modify entity @s Item.tag.display.Lore[13] set from block ~ 0 ~ Text1

#weight
data modify block ~ 0 ~ Text1 set value '[{"translate": "arsenal.item.stats.weight","color": "gray","italic": false},{"score":{"name":"%P90","objective":"ARS_SET_Weight"},"color": "red"}]'
