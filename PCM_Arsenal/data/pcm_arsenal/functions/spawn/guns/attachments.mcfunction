...
execute as @s[nbt={Item:{tag:{attach_muzzle:0b,arsenal_muzzle_able:1b}}}] run data modify entity @s Item.tag.display.Lore[19] set from block ~ 0 ~ Text1
...
execute as @s[nbt={Item:{tag:{attach_optics:0b,arsenal_optics_able:1b}}}] run data modify entity @s Item.tag.display.Lore[20] set from block ~ 0 ~ Text1
...
execute as @s[nbt={Item:{tag:{attach_underbarrel:0b,arsenal_ub_able:1b}}}] run data modify entity @s Item.tag.display.Lore[21] set from block ~ 0 ~ Text1
...
execute as @s[nbt={Item:{tag:{arsenal_muzzle_able:0b}}}] run data modify entity @s Item.tag.display.Lore[19] set from block ~ 0 ~ Text1
...
execute as @s[nbt={Item:{tag:{arsenal_optics_able:0b}}}] run data modify entity @s Item.tag.display.Lore[20] set from block ~ 0 ~ Text1
...
execute as @s[nbt={Item:{tag:{arsenal_ub_able:0b}}}] run data modify entity @s Item.tag.display.Lore[21] set from block ~ 0 ~ Text1
