...
scoreboard players remove @s[scores={ARS_ATCH_Recoil=1..}] ARS_ATCH_Recoil 1
execute as @s at @s store result block ~ 0 ~ Items[0].tag.arsenal_recoil byte 1 run scoreboard players get @s ARS_ATCH_Recoil

execute as @s at @s store result score @s ARS_ATCH_Weight run data get block ~ 0 ~ Items[0].tag.arsenal_weight
scoreboard players add @s ARS_ATCH_Weight 1
execute as @s at @s store result block ~ 0 ~ Items[0].tag.arsenal_weight byte 1 run scoreboard players get @s ARS_ATCH_Weight
