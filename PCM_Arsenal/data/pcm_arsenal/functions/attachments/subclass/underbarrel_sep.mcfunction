...
#folding_grip
execute as @s[nbt={Inventory:[{Slot:-106b,tag:{arsenal_attachment:"folding_grip"}}]}] as @s[nbt={SelectedItem:{tag:{arsenal_ub_able:1b,attach_underbarrel:0b}}}] run function pcm_arsenal:attachments/subclass/underbarrel/folding_grip
...
#flashlight_grip
execute as @s[nbt={Inventory:[{Slot:-106b,tag:{arsenal_attachment:"flashlight_grip"}}]}] as @s[nbt={SelectedItem:{tag:{arsenal_ub_able:1b,attach_underbarrel:0b}}}] run function pcm_arsenal:attachments/subclass/underbarrel/flashlight_grip
